...
public class SettingsFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ConstraintLayout clSignOut = getView().findViewById(R.id.cl_setting_signout);
        ...
        ConstraintLayout clL = getView().findViewById(R.id.cl_setting_changelanguage);
        clL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity() , LanguageSelection.class);
